...
from triton_template.gemm_add_layernorm import triton_matmul_bias_layernorm #(A, B, bias)
from triton_template.gemm_gemm import triton_matmul_batch  # (A, B, D, bias)
...
if __name__ == "__main__":
    ...
    if(test_STOF_Compile == True and is_4080_laptop == False):
        if(hidden_dim != 768):
            config = {
                "is_4080_laptop": is_4080_laptop,  # 直接使用布尔值
                "is_4090": is_4090,
                "is_A100": is_A100,
